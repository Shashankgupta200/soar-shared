...
type QueryInput struct {
	...
	// For OpenAI assistant with Soar labels
...
type PublicProfile struct {
	...
	SoarEarnings     string              `datastore:"soar_earnings" json:"soar_earnings"`
	SoarRanking      string              `datastore:"soar_ranking" json:"soar_ranking"`
...
type LeadInfo struct {
	...
	TestingSoar bool `json:"testing_soar,omitempty" datastore:"testing_soar"`
...
type SyncUsage struct {
	...
	SoarGPT         SyncDataUsage `json:"soar_gpt" datastore:"soar_gpt"`
}
...
type SyncFeatures struct {
	...
	SoarGPT         SyncData    `json:"soar_gpt" datastore:"soar_gpt"`
}
...
type OrborusExecutionRequest struct {
	...
	SoarPassProxyToApp string            `json:"soar_pass_proxy_to_app"`
